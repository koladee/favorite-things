<template>
  <div id="app">
      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="myNavbar">
          <ul class="nav navbar-nav">
            <li id="home-bt" v-if="loginsess" v-bind:class="homeTabClass" v-on:click="dashboard" ><a href="#">
              <i class="glyphicon glyphicon-plus"></i> ADD NEW</a></li>
            <li id="list-bt" v-if="loginsess" v-bind:class="listTabClass" v-on:click="favoriteList"><a href="#">
              <i class="glyphicon glyphicon-list-alt"></i> FAVORITE LIST</a></li>
          </ul>
    ...
    <Dashboard v-if="loginsess" v-bind:activeUser="activeUser" v-bind:showList="showList" v-bind:hideList="showList" />
...
export default {
  name: 'App',
  components: {Index, Dashboard, Lists},
  data () {
    return {
      message: '',
      lists: [],
